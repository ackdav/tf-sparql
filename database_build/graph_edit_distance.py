...
def get_distances(query):
    ...
    for benchmark_query in benchmark_queries:
    	try:
            ...
            cmd = [os.path.join(os.path.dirname(__file__), "../../ged-wrap/scripts/qdistance-vj")+" --std \"%s\" \"%s\" --vj" % (query, benchmark_query)]
